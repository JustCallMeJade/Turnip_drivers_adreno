...
cd "$workdir"
alias install="dnf update -y && dnf builddep mesa -y && dnf install pkg-config git cmake gcc gcc-c++ meson ninja-build python3 pkg-config libepoxy-devel libdrm-devel mesa-libgbm-devel libX11-devel vulkan-loader-devel libva-devel -y"
